...
(drops volatile `asset.generator`/`copyright`, sorts every object's keys, pretty-prints), and diffs the result
against the committed golden here. Any un-acknowledged difference fails the gate — the diff is the change record.
